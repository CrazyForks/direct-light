...
- 重做 `/showcase/` 展示页：保留 Apple 式的克制、尺度与滚动节奏，但改成 Direct Light 自己的黑色工作台视觉；真实产品视频进入首屏，灯光 / 阴影 / 镜头截图可交互切换，并新增能力卡片、三步工作流、经过重新编排的中英文文字层级、移动端布局、键盘焦点和减少动效支持。主应用、媒体素材、依赖、构建配置与 `v1.0.3` 均未改变。
