...
const ja: Record<Key, string> = {
  'compare.title': 'A/B比較',
  'compare.subtitle': '左のAを編集しながら、右のBを固定した比較対象として確認できます。',
  'compare.bPresetLabel': 'Bに使うプリセット',
  'compare.pickFromPresets': '保存済みプリセットを選択…',
  'compare.noPresets': '保存済みプリセットはありません',
  'compare.freeze': '現在の状態をBに固定',
  'compare.freezeTitle': '現在のAをBに固定します。その後Aを編集すると、変更前後を比較できます。',
  'compare.swap': '⇄ AとBを入れ替え',
  'compare.swapTitle': 'Bを編集対象のAに移し、現在のAを比較用のBに入れ替えます。',
  'compare.bStatusPrefix': 'B：',
  'compare.notSet': '未設定',
  ...
  'compare.empty.title': 'A/B比較を始める',
  'compare.empty.desc': '現在のシーンをBに固定してから左のAを編集すると、変更前後を比較できます。',
  'compare.empty.pickFromPresets': '保存済みプリセットをBに設定 ·',
  'compare.empty.pickCount': '{count}件から選択…',
  'compare.empty.noPresets': '保存済みプリセットがありません · 通常ビューで保存してからお試しください',
  'compare.empty.exit': '比較を終了して通常ビューに戻る',
