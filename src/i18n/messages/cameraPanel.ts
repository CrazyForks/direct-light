...
const ja: Record<Key, string> = {
  ...
  'cameraPanel.subtitle': 'レンズと位置',
  'cameraPanel.section.lens': 'レンズ',
  'cameraPanel.focal': '換算焦点距離',
  'cameraPanel.aspect': 'アスペクト比',
  'cameraPanel.section.position': 'カメラ位置',
  'cameraPanel.azimuth': '水平方向',
  'cameraPanel.distance': '距離',
  'cameraPanel.elevation': '高さ',
  'cameraPanel.lookHeight': '注視点の高さ',
  'cameraPanel.section.target': 'ターゲット',
  'cameraPanel.mode': 'モード',
  'cameraPanel.mode.manual': '手動',
  'cameraPanel.mode.person': '人物を追従',
  'cameraPanel.mode.peopleCenter': '人物全体の中心',
  'cameraPanel.lockTarget': '追従する人物',
  'cameraPanel.aimOnce': '一度だけ{name}に向ける',
  'cameraPanel.section.presets': 'アングルプリセット',
  'cameraPanel.section.fromFree': 'フリービューの構図を使う',
  'cameraPanel.setFromFree': 'この構図をカメラに反映',
  'cameraPanel.switchToFree': 'フリービューで調整',
  'cameraPanel.fromFreeHint': 'フリービューでアングルを決めたら、その構図をメインカメラに反映できます。',
}
