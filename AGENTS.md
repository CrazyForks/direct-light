...
Current roadmap note: v0.6 is complete. v0.7 is the open-source-ready first release / optional desktop packaging pass, and the user wants Codex to lead it. v0.7 completion is enough to open source the project. Do not block the first open-source release on multilingual UI or more light sources; those are post-open-source work (v0.8 multilingual, v0.9 more lights / multi-light management).
...
14. Next: v0.7 open-source-ready first release / optional desktop packaging. Codex leads; Codex reviews product/spec/docs; Hermes only drafts explicitly assigned small patches.
