...
- Released baseline: `v1.0.4` (onboarding + usability/reliability hardening, over the `v1.0.3` shadow fix, `v1.0.2` figure models, `v1.0.1` drag bounds, and `v1.0.0` multilingual stable release).
